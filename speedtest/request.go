...
func (s *Server) DownloadTest() error {
	return s.downloadTestContext(context.Background(), dlWarmUp, downloadRequest)
}
...
func (s *Server) DownloadTestContext(ctx context.Context) error {
	return s.downloadTestContext(ctx, dlWarmUp, downloadRequest)
}
...
func (s *Server) UploadTest() error {
	return s.uploadTestContext(context.Background(), ulWarmUp, uploadRequest)
}
...
func (s *Server) UploadTestContext(ctx context.Context) error {
	return s.uploadTestContext(ctx, ulWarmUp, uploadRequest)
}
